...
\subsubsection{} \N{Le-} creates adjectives from other words, very
frequently from nouns, such as \N{le\ACC{hrr}ap} \E{dangerous}
from \N{\ACC{hrr}ap} \E{danger}.  But forms are also seen derived from
verbs (\N{le\ACC{ha'}} \E{suitable, fitting} from \N{ha'} \E{suit,
fit}), from a particle (\N{le\ACC{tut}} \E{constant} from \N{tut}, a
continuation marker), from adverbs (\N{le\ACC{ye'}krr} \E{early}
from \N{ye'krr} \E{early}), and from a compound or phrase
(\N{le\ACC{pxìm}rum} \E{common, often found}
from \N{pxìm} \E{often,} \N{run} \E{find}).
\index{le-@\textbf{le-}}
...
\subsection{Munsna-} From the word \N{munsna} \E{pair,} this prefix is
used to indicate a single pair of something, especially things that
naturally occur in pairs (except body parts, where the dual is usual),
such as \N{munsnahawnven} \E{a pair of shoes}.  The prefix takes no
stress, \N{munsna\ACC{tu}te} \E{a pair of people, a duo}.
...
morning}.  Such forms can also be used as nouns, as in \Npawl{fìtrrä
ftxozäri} \E{today's celebration.}
\index{fiì-@\textbf{fì-}!in adverbs of time}
\LNWiki{22/4/2010}{https://wiki.learnnavi.org/index.php/Earth\_Day\_Message}
...
\N{pxiswaw\ACC{am}} \E{just a moment
ago,} \N{txo\ACC{nam}} \E{last night.}  These forms can also be used
as noun, as in \Npawl{kintrramä sätsyìl lu h errap} \E{last week's
climb was dangerous.}
\index{-am@\textbf{-am}}

\subsection{The Next Time} The accented suffix \N{-ay} creates an
adverb for the next unit of time, \N{trr\ACC{ay}} \E{tomorrow}, 
\N{ha'ngi\ACC{ray}} \E{tomorrow afternoon}.  These forms can also be
used as nouns, \Npawl{Zìsìtayri srefereiey nìprrte’!} \E{(I'm) looking
forward to next year!}
\index{-ay@\textbf{-ay}}
% For zìsìtayri: \NTeri{30/6/2016}{https://naviteri.org/2016/06/mrrvola-lifyavi-amip-forty-new-expressions/}
