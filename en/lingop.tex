...
\subsubsection{} \N{-yu} creates agent nouns from verbs, as in
\N{taronyu} \E{hunter} from \N{taron} \E{hunt}.  This suffix is freely
productive. \index{-yu@\textbf{-yu}}
...
names may lose syllables when taking this suffix, \N{Kamtsyìp} or
...
\E{weather}.  It is nonetheless widely productive, \Npawl{kilvanfkeyk
...
unaccented suffix is attached to color adjectives to form color nouns,
