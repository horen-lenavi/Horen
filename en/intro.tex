...
The main differences between the two dialects are phonological and
lexical.  Among the phono\-logical differences, there are different
pronunciations for the ejective consonants, a different treatment of
the glottal stop between vowels, and a vowel merger in Forest Na'vi
that didn't happen in Reef Na'vi, which thus retains \N{u} and \N{ù}
as separate vowel phonemes.  One example of a lexical difference is
that Reef Na'vi favors \N{syawm} \E{know} where Forest Na'vi
uses \N{omum}.
