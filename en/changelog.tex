...
{\small
\changelog{1.28}{????}{slang section added; many minor style and
formatting tweaks; some examples and citation backfill; full set
of \N{tsa-} conjunction contractions; visual version of legal syllable
rules; productivity of \N{-yu} with \N{si}-verbs; clarification on
omission of \N{san} or \N{sìk}; refinement on use of \N{pum}; numbers
after \N{zam}; \N{-tsim} compound element; modals that take \N{futa}
section redone; redo syntax section for \N{sno}}
