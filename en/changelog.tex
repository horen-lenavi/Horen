...
questions; fixed two counts of typo for word ``conjunction". Added new subsection for lenition of proper nouns}
...
formatting tweaks; some examples backfill; full set of \N{tsa-}
conjunction contractions; visual version of legal syllable rules}
