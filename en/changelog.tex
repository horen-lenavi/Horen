...
{\small
\changelog{1.32}{?? ?? ??}{usage of \N{fì'u} vs.\ \N{tsa'u}
nominalizations; \N{aylahe} short forms; more \N{pak} examples;
genitives of \N{po} derived pronouns (\N{frapo}, etc.); the
usual collection of typo fixes, minor style changes, and additional
citations.} 
