...
our young friend, Marcus}}.  However, the conjuction \N{alu} is
...
(\horenref{syn:conditionals}), with the conjunction \N{tsnì}
\QUAESTIO{when used with certain verbs} (\horenref{syn:tsni}). 
...
\subsection{Sì} The conjuction \N{sì} \E{and} is used for making lists
...
kinds of report clause which cause the verb to take the subjunctive,
...
\QUAESTIO{The verb determines the subjunctive, or the construction?}
...
\NTeri{3/8/2019}{http://naviteri.org/2016/06/mrrvola-lifyavi-amip-forty-new-expressions/comment-page-1/#comment-30185}
