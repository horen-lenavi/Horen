...
\glll Fra'ut fkol skera'a. \\
      ...
      everything-\I{pat} one-\I{agt} destroy\INF{\I{ipfv}} \\
...
\subsection{Subject Dropping} \index{subject!dropping}
...
\glll Txo nga ngeyn livu, tsurokx. \\
      txo nga ngeyn l\INF{iv}u, tsurokx \\ 
      if you tired be\INF{\I{subj}}, rest \\
