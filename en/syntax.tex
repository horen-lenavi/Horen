...
uninflected noun or adjective with the verb stem \N{si} \E{to do, to
make}, which is only used in these compounds, \N{irayo si} \E{to
thank}, \N{kavuk si} \E{to betray}.  These verbs are always
...
and agentive subjects (\horenref{morph:pre-first}).
...
as in \Npawl{lu law \uwave{'uo alahe}, ma eylan} \E{\uwave{something
else} is clear, my friends}.
...
create free choice indefinites.  The clause with \N{ketsran} often,
though not always, takes the subjunctive,
\index{indefinites!free choice}\index{ketsran@\textbf{ketsran}}

\begin{quotation}
\noindent\Npawl{Ketsran tute nivew hivum, poru plltxe san rutxe 'ivì'awn.}\\
\indent\E{No matter who wants (or: may want) to leave, tell them to please stay.}\\
\noindent\Npawl{'U aketsran tsun tivam.}\\
\indent\E{Anything at all will be fine.}\\
\noindent\Npawl{Ketsran fya'o sivunu ngar, kem si.}\\
\indent\E{Do it however you'd like.}\\
...
my best friend, Bob, that he should learn Na'vi, too}.}
to other nouns are in the subjective case, \Npawl{aylì'ufa
\uwave{awngeyä 'eylanä a'ewan Markusì}} \E{in the words \uwave{of
our young friend, Marcus}}.  However, the conjunction \N{alu} is
...
\E{become} and \N{'efu} \E{feel}, as in \N{ngenga slìyu Na'viyä hapxì}
\E{you will become part of the people}, \N{oe 'efu ohakx} \E{I am
(feel) hungry}.
...
\subsection{Direct Address}  When speaking to an individual directly
the vocative particle \N{ma} precedes the relationship noun, noun
phrase or name, \Npawl{oel ayngati kameie, ma oeyä eylan} \E{I see
you, my friends,} \Nfilm{ma Tsu'tey, kempe si nga?} \E{Tsu'tey, what
are you doing?}.\index{vocative}\index{direct address}
\index{ma@\textbf{ma}}
...
\subsection{Sno} \index{sno@\textbf{sno}} The reflexive
pronoun \N{sno} refers to the subject of the sentence.  In the
genitive it may be translated \E{his own, her own, their own, etc.}
...
\noindent \N{Sno} is for third person antecedents only.
...
\subsection{PRO-Drop} A subject pronoun (subjective or agentive) may
be dropped if it is the same as the subject of the previous
statement.  Note the lack of a subject pronoun in the second sentence:
\index{PRO-drop}
...
forms of \N{fì'u} and \N{tsa'u} in this construction.
...
immediately after the verb, the adposition \N{ne} may optionally be
...
\N{fìtseng lu awngeyä} \E{this place is ours}.  However, the prop noun
\N{pum} \E{possession, thing possessed} is more often used,
...
giving thanks, \Npawl{\uwave{tìmweypeyri ayngeyä} seiyi irayo nì\-ngay}
\E{I really thank you \uwave{for your patience}}.
...
quite common in Human languages.} \Npawl{\uwave{oeri} nì'i'a
\uwave{tsyokx} zoslolu} \E{\uwave{my hand} is finally healed,}
\Npawl{oeri tìngayìl txe'lanit tivakuk} \E{let the truth strike my
heart,} \Npawl{\uwave{ngari tswintsyìp} sevin nìtxan lu nang!} \E{what
a pretty little queue you have!}  Note in the first two examples that
...
young friend}.\index{adpositions!position}\label{syn:adp:position}
...
\subsubsection{With ``sre''} When paired with the adposition \N{sre}
they mean ``by'' in the temporal sense of ``before or up to but, not
after,'' \Npawl{kem si li trraysre} \E{do it by
...
freely to produce adverbs of manner.  Here the entire noun phrase is
adverbialized, not just the word \N{nì-} is prefixed to, \N{nì-[fya'o
letrrtrr]} \E{in an ordinary way}, \Npawl{poe poltxe nìfya'o alaw}
\E{she spoke clearly}.
...
\subsection{Sunkesun} The adverb \N{sunkesun} \E{like it or not} is a shortened form of \N{sunu ke sunu} with the default addressee being \E{you}, \Npawl{sunkesun po slayu olo'eyktan} \E{whether you like it or not, he's going to become chief.}
\index{sunkesun@\textbf{sunkesun}}
\NTeri{6/6/2019}{http://naviteri.org/2019/06/50a-liu-amip-40-new-words/}

\subsubsection{} Note that \N{sunkesun} can only be addressed to the listener, otherwise one must use a \N{ftxey... fuke} construction, \Npawl{pol vìyewng ayevengit fìha'ngir, ftxey sunu fuke} \E{He is going to take care of the children this afternoon, whether he likes it or not.}
...
\uwave{harmahängaw}} \E{when I \uwave{gave} them these words perhaps
...
\Npawl{ayngaru seiyi irayo} \E{I thank you}.  Second, it marks
...
\N{\INF{ìsy}} and \N{\INF{asy}} indicate the determination by the
...
modal, \N{oe namew tsive'a} \E{I wanted to see,} never \N{*oe new
tsimve'a}.  However, the controlled verb will keep its causative or
reflexive marking. 

Except in poetry or ceremonial language, the modal verb will always
come before the controlled verb.
...
\subsubsection{} When \N{ke} is used with modal verbs, it may go either in front of the modal verb or in front of the controlled verb.  In some cases, this changes the meaning as with \N{ke zene kivä} \E{do not have to go} versus \N{zene ke kivä} \E{must not go} or \N{po ke tsun yivom} \E{they are not able to eat} versus \N{po tsun ke yivom} \E{they are able to not eat}. \label{syn:modal:neg}
...
(\horenref{syn:modals}), \N{new} \E{want} may also introduce a
...
dative objects reflexive pronoun \N{sno} is used,
...
\N{-pe+} is sufficient to create a question, \N{kempe si nga?} \E{what
...
\E{something must have frightened the banshee, because it suddenly
took to the air.}
\index{evidential}
...
(\horenref{morph:correlatives}) is used \N{ke} is still required with
...
with \N{ke... kaw'it} \E{not... at all}, as in \N{fo ke lu 'ewan
...
Additional verbs may be introduced in a sequence by inserting \N{tsakrr}.
...
modify nouns directly with prepositional phrases (``the man on the
...
likely candidates: \N{fpi}, \N{mìkam}, \N{mungwrr}, \N{pxel/na},
\N{vay}?  Or the dictionary may be the better place for a full list.} 
...
conjunction \N{txo} \E{if}.  The consequent is optionally introduced
by \N{tsakrr} \E{then}.
...
(\horenref{syn:question:ftxey}), \N{ftxey} can be used to enumerate
\E{whether... or...} options, \Npawl{sìlpey oe, \dots\ frapo ---
\uwave{ftxey sngä'iyu ftxey tsulfätu} --- tsìyevun fìtsenge rivun 'uot
lesar} \E{I hope ... everyone --- \uwave{whether beginner or expert} ---
will be able to find something useful here}.
...
\Npawl{Nulnew ngal \uwave{fu} fì’ut \uwave{fu} tsa’ut?}
...
\subsection{Tsnì} The conjunction \N{tsnì} \E{that} introduces some
kinds of report clause,
\N{ätxäle si tsnì livu oheru Uniltaron} \E{I respectfully request the
Dream Hunt}, \Npawl{sìlpey oe tsnì fìtìoeyktìng law livu ngaru set}
\E{I hope that this explanation is clear to you now}.
% http://naviteri.org/2011/02/new-vocabulary-part-2/
\label{syn:tsni}\index{tsnì@\textbf{tsnì}}

\subsubsection{} Verbs known to take \N{tsnì}: \N{ätxäle si},
\N{rangal} (a marginal use), \N{sìlpey}, \N{la'um}, \N{mowar si}, \N{fe'pey}, \N{leymfe'}, \N{leymkem}, \N{srefey}, and \N{srefpìl}.  \N{sìlpey} requires the verb in the clause which \N{tsnì} introduces to use the subjunctive, and it follows that \N{rangal}, \N{ätxäle si}, \N{mowar si}, and \N{fe'pey} likely require it as well.  The others do not use the subjunctive.
% http://naviteri.org/2020/02/some-words-for-leap-year-day/#comment-30895
% http://forum.learnnavi.org/language-updates/confirmation-on-use-of-rangal/

\subsubsection{} \QUAESTIO{\N{Tsnì} seems most often used when
intransitive constructions are in the main clause.}
...
need to close the quotation with \N{sìk}.
...
didn't say that}, \N{oel poru pasyawn tsat} \E{I will ask him that}.
\NTeri{31/8/2011}{http://naviteri.org/2011/08/reported-speech-reported-questions/}
