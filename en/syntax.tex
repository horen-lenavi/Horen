...
\LNForum{1/3/2010}{https://forum.learnnavi.org/?msg=123484}
...
[\I{adv} \N{lu} \I{adj}] once, \Nfilm{peyä menarisì \uwave{nìhawng lu}
...
\subsection{Intentional Future} \label{syn:verb:intenfut}\index{future!intentional}
The intentional future forms in \N{\INF{ìsy}} and \N{\INF{asy}}
indicate the deter\-mina\-tion by the speaker to bring about a state
of affairs, rather than a prediction about the future.  \Npawl{pìsyeng
oe ngar} \E{I will tell you,} \Npawl{tafral ke \uwave{lìsyek} oel
ngeyä keye'ungit} \E{therefore I will not heed your insanity}.

Under negation the intention is that something not happen, rather than
not having an intention for something to happen.

\begin{interlin}
\glll Ayoe ke wasyem. \\
     ay-oe ke w\INF{asy}em \\
     \I{pl}-\I{1} not fight\INF{\I{int.fut}} \\
\trans{We will not fight} i.e., ``I intend that we will not fight.''
\end{interlin}

Due to the meaning of the intentional future, it is used exclusively
with the first person.  However, note this example:

\begin{interlin}
  \glll Ke zasyup lì'Ona ne kxutu a mìfa fu a wrrpa. \\
   ke z\INF{azy}up lì'Ona ne kxutu a mìfa fu a wrrpa \\
   not fall\INF{\I{int.fut}} l'Ona to enemy \I{rel} inside or \I{rel} outside\\
\trans{The l'Ona will not perish to the enemy within or the enemy without} \Ipawl{}
\end{interlin}

\noindent Here the speaker is using \N{lì'Ona} \E{l'Ona} to refer to a
group to which they belong.  It's not quite a replacement for a first
person pronoun, but close enough to allow the use of the intentional
future.
\LNWiki{29/3/2010}{https://wiki.learnnavi.org/index.php/Canon/2010/March-June\%23Intentional_Future_Details}
\LNForum{22/12/2024}{https://forum.learnnavi.org/language-updates/you-shall-not-pass-does-not-use-ltisygt-or-ltasygt/}
\NTeri{28/12/2024}{https://naviteri.org/2024/12/odds-and-ends/}
...
\noindent Note here that the subclause does not require the
...
\subsection{Causative of Modals} \index{causative!of modal}
Modal verbs do not take causative marking.  However,
when \N{new} \E{want} is acting as a transitive verb it can still be
transitivized, including when it takes a \N{futa}
clause, \Npawl{fìpamtseol oeru neykew futa srew} \E{this music makes
me want to dance}.
\LNForum{29/11/2020}{https://forum.learnnavi.org/language-updates/causative-with-new-and-other-modals/}
...
\subsection{Contrafactual} \label{counterfactual}
Contrafactual questions use a separate set of
conjunctions, \N{zun} \E{if} and \N{zel} \E{then}.  The subjunctive is
used in both clauses, with the following tense senses:
\index{conditional sentence!counterfactual}
\index{counterfactual!conditional sentence}
...
\subsubsection{}
Counterfactual ``should have'' is based on conditional counterfactuals
with \N{zun... zel} (\horenref{counterfactual}), shortening \N{zun nga
kilvä, zel sweylu} \E{if you had gone it would have been better} to
just \N{sweylu zun nga kilvä} \E{you should have gone} (better in the
past) or from \N{zun nga kilvä, zel sweylivu} to \N{sweylivu zun nga
kilvá} \E{you should have gone} (better for the present situation).
\NTeri{28/12/2024}{https://naviteri.org/2024/12/odds-and-ends/}
\index{sweylu@\textbf{sweylu}!counterfactual}
\index{counterfactual!with sweylu@\textbf{sweylu}}
