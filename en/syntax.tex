...
\section{Questions}
\index{question}
\subsection{Yes-no Questions} Simple yes-no questions are marked with
the particle \N{srak(e)} which occurs at the start or the end of the
clause.  When the particle appears at the end of the clause, it is
usually just \N{srak}, the longer \N{srake} occurring at the beginning
of the clause.  \Npawl{Ngaru lu fpom srak?} \E{are you well?}
