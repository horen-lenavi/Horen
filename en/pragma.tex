...
\subsubsection{Slang} In casual conversation some constructions that
deviate from standard grammar may be used to serve certain purposes.
For example, the mood infixes \N{<ei>} and \N{<äng}} may be inserted
into \N{<srane>}, \E{<yes>} and \N{<kehe>}, \E{<no>} instead of using
adverbs to express a mood. Additionally, proper names may form a compound
verb with \N{<si>} to express \E{<do as X>}.
