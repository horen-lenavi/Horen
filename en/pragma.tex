...
personal pronouns (as in \N{pot lonu}), demonstrative pronouns
(\N{fì'u}, \N{tsa'u}), as well as nouns with the demonstrative
prefixes (as in \N{tsaswiräti lonu}).  This will explain why so many
...
dative can be, too, as in \N{Omatikayaru tìhawnu sivi}.  Similarly, a
pronoun with an adposition can be fronted, \Nfilm{eo ngenga kllkxem
ohe} \E{I stand before you} (\I{pp v s}).
...
see also \N{fko}, \horenref{syn:prn:fko}).
