...
while \N{tsun} may be either [tsun] or [tsʊn].
...
\subsubsection{} When between two vowels, the glottal stop is normally
dropped in Reef Na'vi.  Both vowels are still distinctly enunciated,
even if they are identical, as in \N{rä'ä} below,
