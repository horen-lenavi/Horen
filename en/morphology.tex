...
Dative & \N{-r}, \N{-ru} & \N{-ur} & \N{-ru}, \N{-ur}, \N{-aw-r}, \N{-ew-r} \\
...
pronoun \N{fì'u} and the inanimate pronoun \N{tsaw} are used with the
attributive particle \N{a} to nominalize clauses
(\horenref{syn:clause-nom}).  When the attributive particle follows
certain case forms of the pronoun, they
contract:\label{morph:fwa-tsawa}
