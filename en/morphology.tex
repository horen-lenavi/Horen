...
\N{fahewr} \E{to/for a smell}.  In both situations the longer case
ending which ends in a vowel could also be used, \N{keyeyti}
and \N{fahewru}. 

With \N{-ay} and \N{-aw}, however, either consonant ending form may be
used, or the simplification may be.  So, \N{wayt}, \N{wayit}
or \N{wayti}; and \N{'etnawr}, \N{'etnawur}, or \N{'etnawru}.
...
dative in \N{-ru} and the topical in \N{-ri}, such
as \Npawl{lì'fyaolo\uwave{'ru}} and \N{lì'fyaolo'ri}.  Otherwise nouns
ending in consonants take \N{-ur} and \N{-ìri}.
...
\N{-o}, \E{one, some.}  Case endings follow the \N{-o}, such
as \N{puk-o-t}.
...
1st inclusive   & —      & \N{o\ACC{e}ng} & \N{pxo\ACC{e}ng} & \N{ayo\ACC{e}ng}, \N{aw\ACC{nga}} \\
...
\end{tabular}
\end{center}
\LNForum{29/8/2013}{https://forum.learnnavi.org/language-updates/confirmation-on-pronunciation-of-oe-words}
...
clusters at the start of a word, such as *\N{mwel}; nor does it happen
in the subjective form of \N{oeng}.  This pronunciation is indicated
with the accenting underline on the \N{e} (except
for \N{oeng}). \label{morph:pron:oe-we}
...
demonstrative \N{tsa'u} \E{that.}  There is also an abbreviated
stem, \N{tsaw} which is just \N{tsa-} when taking case and adposition
suffixes, giving: \N{tsaw, tsal, tsat(i), tsar(u), tseyä, tsari,} as
well as \N{tsafa}.\footnote{Paul says on his blog in the comments
(3 Aug 2011) that a form like \N{tsawfa} might be found, but
using \N{tsaw} with case endings seems not to be allowed.}  The
abbreviated form is also markable for number, \N{mesaw, pxesaw}, etc.
\label{morph:pron:tsa}\index{tsaw@\textbf{tsaw}}\index{tsa'u@\textbf{tsa'u}}
\LNWiki{6/5/2010}{https://wiki.learnnavi.org/index.php/Canon/2010/March-June\#History_of_Tsaw}
\NTeri{3/8/2011}{http://naviteri.org/2011/08/new-vocabulary-clothing/comment-page-1/\#comment-917}
\LNForum{4/12/2024}{https://forum.learnnavi.org/language-updates/forms-of-tsa-u/}
...
When prefixed, the following word takes lenition, such as \N{pehem}
from \N{kem}.  When the prefix is followed by the plural
prefix \N{ay+} they contract into \N{pay+}.

When suffixed to the noun, \N{-pe} does not cause lenition on either
the word it is suffixed to or to the following word.
Suffixed \N{-pe} will come before any case endings, but
having \N{-pe} follow a case ending has been mentioned as a possible
non-standard outcome in spontaneous speech.
...
\N{fì-} \\
\N{tsa-} & \N{fra-} & number marking & \N{fne-} & the noun & \N{-pe} & case ending\\
\N{pe+}
\end{tabular}
\end{center}
